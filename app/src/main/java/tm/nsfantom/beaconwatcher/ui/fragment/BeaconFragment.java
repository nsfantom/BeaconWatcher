...
public class BeaconFragment extends Fragment {
    ...
    public static BeaconFragment newInstance(Beacon beacon) {
        BeaconFragment deviceFragment = new BeaconFragment();
        deviceFragment.beacon = beacon;
        deviceFragment.deviceName = beacon.getBluetoothName();
        deviceFragment.deviceAddress = beacon.getBluetoothAddress();
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            // Automatically connects to the beacon upon successful start-up initialization.
            bluetoothLeService.connect(deviceAddress);
        }
    ...
    // ACTION_DATA_AVAILABLE: received data from the beacon.  This can be a result of read
