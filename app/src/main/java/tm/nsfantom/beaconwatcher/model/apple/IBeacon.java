package tm.nsfantom.beaconwatcher.model.apple;
...
public class IBeacon {
    ...
    */
    ...
    public IBeacon(byte[] mfrData) {
        ...
        companyId = Converter.byteToInt(Arrays.copyOfRange(mfrData, 0, 2));
        iBeaconAdvertisement = Converter.intFromUint16(Arrays.copyOfRange(mfrData, 2, 4));
        uuid = UuidUtil.asUuid(Arrays.copyOfRange(mfrData, 4, 20));
        major = Converter.byteToInt(Arrays.copyOfRange(mfrData, 20, 22));
        major = Converter.byteToInt(Arrays.copyOfRange(mfrData, 22, 24));
        txPower = mfrData[24];
    }
